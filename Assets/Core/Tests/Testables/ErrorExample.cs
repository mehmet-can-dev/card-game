...
{
    public class ErrorExample : ITestableCards
    {
        public NumericColoredCard[] GetNotSortedCards()
        {
            return new[]
            {
                new NumericColoredCard(0, 5, ColorConstants.Black),
                new NumericColoredCard(1, 5, ColorConstants.Black),
                new NumericColoredCard(2, 5, ColorConstants.Blue),
                new NumericColoredCard(3, 5, ColorConstants.Blue),
                new NumericColoredCard(4, 5, ColorConstants.Red),
                new NumericColoredCard(9, 5, ColorConstants.Red),
